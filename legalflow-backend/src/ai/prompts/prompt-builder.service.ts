...
4. Tuân thủ nguyên tắc an toàn AI: sử dụng ngôn ngữ gợi ý, tham khảo, tuyệt đối không dùng từ ngữ khẳng định thay thế kết luận thẩm tra của cán bộ có thẩm quyền.`;
  }
...
Văn bản cần tuân thủ thể thức hành chính chuẩn (Nghị định 30/2020/NĐ-CP về công tác văn thư). Trả về JSON format: { "draftTitle": "...", "draftContent": "...", "legalReferences": ["Luật..."] }. Lưu ý an toàn AI: Văn bản soạn thảo là bản gợi ý tham khảo, cán bộ phải kiểm tra, chỉnh sửa trước khi sử dụng. Bắt buộc ghi vùng giữ chỗ "[Cán bộ bổ sung...]" nếu thiếu thông tin.`;
  }
}
